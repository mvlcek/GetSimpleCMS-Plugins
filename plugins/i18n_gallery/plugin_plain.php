<?php
i18n_gallery_register('plain', 'plain', 
  'This plugin shows the images in a <strong>plain</strong> list with no interactivity.<br/>'.
  'License: GPL<br/>'.
  '',
  'i18n_gallery_plain_edit', 'i18n_gallery_plain_header', 'i18n_gallery_plain_content');

function i18n_gallery_plain_edit($gallery) {
?>
  <p>
...
function i18n_gallery_plain_header($gallery) {
  global $SITEURL;
...
function i18n_gallery_plain_content($gallery, $pic) {
  global $SITEURL;
  $id = i18n_gallery_id($gallery);
  $w = @$gallery['width'] ? $gallery['width'] : (@$gallery['height'] ? (int) $gallery['height']*$gallery['items'][0]['width']/$gallery['items'][0]['height'] : $gallery['items'][0]['width']);
  $h = @$gallery['height'] ? $gallery['height'] : (@$gallery['width'] ? (int) $gallery['width']*$gallery['items'][0]['height']/$gallery['items'][0]['width'] : $gallery['items'][0]['height']);
